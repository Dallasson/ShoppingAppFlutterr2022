...
import 'package:shopping/customer/customer_password.dart';
import 'package:shopping/customer/customer_signup.dart';
            ...
            children: [
              ...
              Center(
                child: GestureDetector(
                  onTap: (){
                    Get.to(() => const CustomerPasswordScreen());
                  },
                    ...
                    child :  Padding(
                      ...
                      child: ElevatedButton(onPressed: () async {
                        ...
                        if(emailKey.currentState!.validate() && passwordKey.currentState!.validate()){
                          var user = await FirebaseHelper().signInCustomer(email, password);
                          if(user.user != null){
                            setState(() {
                              isVisible = false;
                            });
